...
export default function Footer() {
  return (
    <footer className="pt-[48px] lg:pt-[64px] bg-black">
      <div className="flex flex-col justify-between h-[473px] lg:h-[900px] p-[16px]">
        {/* FOOTER TOP */}
        <div className="flex flex-col lg:flex-row justify-between gap-[24px] lg:gap-[16px]">
          <div>
            <h5 className="text-h10 lg:text-h4">Città di Lugano</h5>
            <h6 className="text-h10 lg:text-h4 text-[rgba(255,255,255,0.56)]">
          ...
          <div className="flex gap-[16px]">
            <ul className="flex flex-col gap-[16px] w-[163.5px] lg:w-[340px]">
