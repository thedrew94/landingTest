...
export default function Slider() {
  ...
  return (
    <div className="swiper w-full h-[394px] lg:h-[540px]">
        ...
        {slides &&
          ...
          slides.map((sEl, idx) => {
            return (
              <div
                key={`slide_el_${idx}`}
                className="swiper-slide relative w-full max-w-[319px] lg:max-w-[437px] h-full bg-red-400 overflow-hidden group"
              >
                <Image
                ...
                <div className="absolute z-1 top-0 left-0 w-full h-full">
                  ...
                  <div className="absolute bottom-[-110px] right-0 w-[calc(100%-48px)] h-[180px] duration-250 bg-white transition-all group-hover:bottom-0">
                    <div className="h-full p-[16px]">
                      <h3 className="text-h10 lg:text-h4 text-black">{sEl.title || "title_undefined"}</h3>
